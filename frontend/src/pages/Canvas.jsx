...
class Canvas extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://innovators-canvas.herokuapp.com:9000/userinfo', {withCredentials: true})
            .then(res => {
                var data = res.data;
                if(data.netid) {
    ...
    updateInfo() {
        ...
        xhr.open('POST', 'https://innovators-canvas.herokuapp.com:9000/canvas_data', true);
